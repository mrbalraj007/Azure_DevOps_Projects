...
cd myagent
./config.sh --unattended --url https://dev.azure.com/mrbalraj --auth pat --token xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx --pool Terraform-Demo-pool --agent aksagent --acceptTeeEula
