...
resource "azurerm_linux_virtual_machine" "vm" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      #"cd myagent",
      "./config.sh --unattended --url https://dev.azure.com/<Update here your Azure organization name> --auth pat --token <update here PAT token> --pool Terraform-Agent-pool --agent aksagent --acceptTeeEula",
